    ...
    case Method of
        <<"OPTIONS">> ->
            Req4 = cowboy_req:set_resp_header(
                <<"access-control-allow-methods">>, <<"GET, PUT", "POST">>, Req3
            ),
            Req5 = cowboy_req:set_resp_header(
                <<"access-control-allow-headers">>, <<"Authorization">>, Req4
            ),
...
% -spec check_origin(Origin, [Origin] | '*') -> boolean() when
%     Origin :: {binary(), binary(), 0..65535} | reference().
